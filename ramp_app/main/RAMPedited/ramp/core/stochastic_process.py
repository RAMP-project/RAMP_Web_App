...
# def Stochastic_Process(j): # edited by NESSI Team
def Stochastic_Process(appliances_list):
    Profile, num_profiles = Initialise_model()
    #peak_enlarg, mu_peak, s_peak, op_factor, Year_behaviour, User_list = Initialise_inputs(j) edited by NESSI Team
    peak_enlarg, mu_peak, s_peak, op_factor, Year_behaviour, User_list = Initialise_inputs(appliances_list)
    '''
